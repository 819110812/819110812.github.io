import{_ as e,o as i,c as n,e as r}from"./app.4402bc79.js";const s={},a=r(`<h1 id="leetcode\u5237\u989814-\u5224\u65AD\u80FD\u5426\u5F62\u6210\u7B49\u5DEE\u6570\u5217" tabindex="-1"><a class="header-anchor" href="#leetcode\u5237\u989814-\u5224\u65AD\u80FD\u5426\u5F62\u6210\u7B49\u5DEE\u6570\u5217" aria-hidden="true">#</a> Leetcode\u5237\u989814 --- \u5224\u65AD\u80FD\u5426\u5F62\u6210\u7B49\u5DEE\u6570\u5217</h1><p>\u7ED9\u4F60\u4E00\u4E2A\u6570\u5B57\u6570\u7EC4 arr \u3002</p><p>\u5982\u679C\u4E00\u4E2A\u6570\u5217\u4E2D\uFF0C\u4EFB\u610F\u76F8\u90BB\u4E24\u9879\u7684\u5DEE\u603B\u7B49\u4E8E\u540C\u4E00\u4E2A\u5E38\u6570\uFF0C\u90A3\u4E48\u8FD9\u4E2A\u6570\u5217\u5C31\u79F0\u4E3A \u7B49\u5DEE\u6570\u5217 \u3002</p><p>\u5982\u679C\u53EF\u4EE5\u91CD\u65B0\u6392\u5217\u6570\u7EC4\u5F62\u6210\u7B49\u5DEE\u6570\u5217\uFF0C\u8BF7\u8FD4\u56DE true \uFF1B\u5426\u5219\uFF0C\u8FD4\u56DE false \u3002</p><p>\u793A\u4F8B 1\uFF1A</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>\u8F93\u5165\uFF1Aarr = [3,5,1]
\u8F93\u51FA\uFF1Atrue
    ...
    def canMakeArithmeticProgression(self, arr: List[int]) -&gt; bool:
        ...
        for i in range(1, len(arr) - 1):
            if arr[i] * 2 != arr[i - 1] + arr[i + 1]:
                return False
        return True
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://golearning.oss-cn-shanghai.aliyuncs.com/obsidian\u626B\u7801_\u641C\u7D22\u8054\u5408\u4F20\u64AD\u6837\u5F0F-\u6807\u51C6\u8272\u7248.png" alt=""></p>`,11),l=[a];function d(c,t){return i(),n("div",null,l)}var u=e(s,[["render",d],["__file","Leetcode\u5237\u989814 --- \u5224\u65AD\u80FD\u5426\u5F62\u6210\u7B49\u5DEE\u6570\u5217.html.vue"]]);export{u as default};
